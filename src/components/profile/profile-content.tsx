...
const STYLES = `
  .pf-wrap{min-height:100vh;background:radial-gradient(ellipse at 50% 0%,rgba(245,158,11,0.04),transparent 60%),var(--bg-primary);padding:20px 14px;display:flex;align-items:center;justify-content:center;}
  ...
  .pf-card{border-radius:20px;background:var(--bg-card);border:1px solid var(--border-subtle);backdrop-filter:blur(18px);padding:28px 20px;text-align:center;position:relative;overflow:hidden;}
  ...
  .pf-avatar{width:64px;height:64px;border-radius:50%;background:linear-gradient(135deg,rgba(245,158,11,0.15),rgba(249,115,22,0.1));color:var(--amber);display:flex;align-items:center;justify-content:center;font-size:26px;font-weight:700;margin:0 auto 12px;border:2px solid rgba(245,158,11,0.2);}
  @media(min-width:480px){.pf-avatar{width:80px;height:80px;font-size:32px;margin-bottom:16px;}}
  .pf-name{font-size:20px;font-weight:700;color:var(--text-primary);margin-bottom:2px;}
  @media(min-width:480px){.pf-name{font-size:24px;}}
  .pf-email{font-size:12px;color:var(--text-muted);margin-bottom:14px;}
  @media(min-width:480px){.pf-email{font-size:14px;margin-bottom:20px;}}
  .pf-goal{display:inline-flex;align-items:center;gap:5px;padding:5px 12px;border-radius:999px;background:rgba(245,158,11,0.08);color:var(--amber);font-size:11px;border:1px solid rgba(245,158,11,0.15);margin-bottom:20px;}
  ...
  .pf-stat{padding:14px 8px;border-radius:12px;background:var(--bg-input);border:1px solid var(--border-subtle);transition:all 0.2s;}
  ...
  .pf-stat-label{font-size:9px;color:var(--text-muted);text-transform:uppercase;letter-spacing:0.06em;margin-top:3px;}
  ...
  .pf-extra-item{display:flex;align-items:center;gap:8px;padding:10px 14px;border-radius:10px;background:var(--bg-input);border:1px solid var(--border-subtle);font-size:11px;color:var(--text-secondary);}
  @media(min-width:480px){.pf-extra-item{padding:12px 16px;border-radius:12px;font-size:12px;}}
  .pf-extra-item strong{color:var(--text-primary);}

  .pf-logout{padding:10px 28px;border-radius:10px;border:1px solid rgba(239,68,68,0.2);background:rgba(239,68,68,0.05);color:var(--red);cursor:pointer;font-size:13px;font-weight:500;font-family:'Inter',sans-serif;display:flex;align-items:center;gap:6px;margin:0 auto;transition:all 0.3s;}
  ...
  .pf-joined{display:flex;align-items:center;gap:6px;color:var(--text-muted);font-size:11px;justify-content:center;margin-top:14px;}
          ...
          <div className="pf-card">
            ...
            <div className="pf-stats">
              <div className="pf-stat">
                <p className="pf-stat-value" style={{ color: "var(--amber)" }}>{user.streak}</p>
              ...
              <div className="pf-stat">
                <p className="pf-stat-value" style={{ color: "var(--green)" }}>{user.level}</p>
            ...
            <div className="pf-extra">
              <div className="pf-extra-item">
                ...
                <span>Best Streak: <strong>{user.longestStreak}</strong></span>
              </div>
              <div className="pf-extra-item">
                <Star size={14} style={{ color: "var(--amber)" }} />
                <span>Commitment: <strong>{user.commitmentLevel}/10</strong></span>
              </div>
            </div>
