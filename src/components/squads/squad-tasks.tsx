...
const STYLES = `
  ...
  .progress-section{margin-bottom:16px;padding:14px 16px;border-radius:14px;background:rgba(15,22,36,0.5);border:1px solid rgba(255,255,255,0.04);backdrop-filter:blur(12px);}
  ...
  .empty-tasks{text-align:center;padding:32px 16px;color:#5a6478;font-size:13px;}
    ...
    <>
      ...
      <div className="st-wrap">
        ...
        <div className="stats-row sr sr-d1">
          {[
            { icon: Target, color: "#f59e0b", value: `${progress}%`, label: "Progress" },
            { icon: Check, color: "#10b981", value: completed, label: "Done" },
            { icon: Flame, color: "#f97316", value: total, label: "Total" },
          ].map((s) => (
        ...
        {total > 0 && (
          <div className="progress-section sr sr-d2">
            <div className="progress-header">
              <p className="progress-title"><Zap size={13} style={{ color: "#f59e0b" }} />Squad Progress</p>
