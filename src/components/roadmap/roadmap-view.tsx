...
const STYLES = `
  .rm-wrap{min-height:100vh;background:radial-gradient(ellipse at 50% 0%,rgba(245,158,11,0.04),transparent 60%),#070c14;padding:20px 14px;position:relative;}
  ...
  .rm-icon{width:52px;height:52px;border-radius:16px;background:linear-gradient(135deg,#f59e0b,#f97316);display:flex;align-items:center;justify-content:center;margin:0 auto 16px;box-shadow:0 14px 36px -14px rgba(245,158,11,0.4);}
  @media(min-width:480px){.rm-icon{width:64px;height:64px;border-radius:20px;margin-bottom:20px;}}
  .rm-title{font-size:26px;font-weight:700;color:#edeff2;margin-bottom:4px;letter-spacing:-0.02em;}
  @media(min-width:480px){.rm-title{font-size:30px;}}
  .rm-sub{font-size:13px;color:#5a6478;}
  @media(min-width:480px){.rm-sub{font-size:14px;}}
  .rm-progress{display:flex;align-items:center;gap:8px;justify-content:center;margin-top:12px;font-size:12px;color:#f59e0b;font-weight:600;}
  ...
  .timeline::before{content:'';position:absolute;left:14px;top:0;bottom:0;width:2px;background:rgba(255,255,255,0.05);z-index:0;border-radius:1px;}
  ...
  /* Dots */
  .tl-dot{position:absolute;left:-22px;top:22px;width:10px;height:10px;border-radius:50%;z-index:2;border:2px solid rgba(255,255,255,0.08);background:#0a1018;transition:all 0.3s ease;}
  ...
  .tl-dot.completed{background:#10b981;border-color:#10b981;box-shadow:0 0 12px rgba(16,185,129,0.3);}
  @media(min-width:768px){.tl-dot.completed{box-shadow:0 0 16px rgba(16,185,129,0.3);}}
  .tl-dot.start{background:#f59e0b;border-color:#f59e0b;box-shadow:0 0 16px rgba(245,158,11,0.3);width:12px;height:12px;top:0;left: 9px;position:absolute;}
  ...
  .tl-dot.finish{background:#f59e0b;border-color:#f59e0b;box-shadow:0 0 16px rgba(245,158,11,0.35);width:14px;height:14px;animation:finishPulse 2s ease-in-out infinite;position:relative;left:-24px;margin-top:12px;}
  ...
  .tl-card{width:100%;padding:14px 16px;border-radius:14px;border:1px solid rgba(255,255,255,0.04);background:rgba(15,22,36,0.55);backdrop-filter:blur(12px);cursor:pointer;transition:all 0.3s ease;display:flex;align-items:center;gap:12px;}
  @media(min-width:480px){.tl-card{padding:16px 20px;border-radius:16px;}}
  @media(min-width:768px){.tl-card{width:350px;}}
  .tl-card:hover{border-color:rgba(245,158,11,0.25);background:rgba(20,28,44,0.7);transform:translateX(4px);box-shadow:0 8px 24px rgba(0,0,0,0.2);}
  ...
  .tl-circle{width:34px;height:34px;border-radius:50%;display:flex;align-items:center;justify-content:center;flex-shrink:0;border:2px solid rgba(255,255,255,0.08);transition:all 0.3s ease;background:rgba(255,255,255,0.02);}
  @media(min-width:480px){.tl-circle{width:40px;height:40px;}}
  .tl-card:hover .tl-circle{border-color:#f59e0b;}
  .tl-card.completed .tl-circle{background:#10b981;border-color:#10b981;}
  .tl-num{font-size:11px;font-weight:700;color:#5a6478;}
  @media(min-width:480px){.tl-num{font-size:13px;}}
  .tl-card.completed .tl-num{color:#fff;}
  .tl-info{flex:1;min-width:0;}
  .tl-title{font-size:12px;font-weight:500;color:#edeff2;line-height:1.5;}
  @media(min-width:480px){.tl-title{font-size:13px;}}
  .tl-card.completed .tl-title{color:#5a6478;text-decoration:line-through;}

  .tl-label{font-size:9px;font-weight:600;text-transform:uppercase;letter-spacing:0.12em;color:#f59e0b;padding-left:2px;}
  ...
  /* Celebration */
  .celebration-overlay{position:fixed;inset:0;z-index:200;background:rgba(0,0,0,0.7);display:flex;align-items:center;justify-content:center;padding:16px;}
  .celebration-card{background:rgba(15,22,36,0.95);border:1px solid rgba(245,158,11,0.2);border-radius:20px;padding:36px 24px;text-align:center;max-width:440px;width:100%;backdrop-filter:blur(20px);position:relative;overflow:hidden;}
  @media(min-width:480px){.celebration-card{padding:48px 40px;border-radius:24px;}}
  .celebration-card::before{content:'';position:absolute;top:0;left:0;right:0;height:2px;background:linear-gradient(90deg,transparent,#f59e0b,#f97316,#10b981,#f59e0b,transparent);}
  ...
  .celebration-title{font-size:22px;font-weight:700;color:#edeff2;margin-bottom:6px;}
  @media(min-width:480px){.celebration-title{font-size:28px;}}
  .celebration-sub{font-size:13px;color:#5a6478;margin-bottom:20px;line-height:1.6;}
  @media(min-width:480px){.celebration-sub{font-size:14px;margin-bottom:24px;}}
  .celebration-btn{padding:10px 28px;border-radius:10px;border:none;cursor:pointer;background:linear-gradient(135deg,#f59e0b,#f97316);color:#0a0a0a;font-size:13px;font-weight:600;font-family:'Inter',sans-serif;}
  @media(min-width:480px){.celebration-btn{padding:12px 32px;border-radius:12px;font-size:14px;}}
  .celebration-close{position:absolute;top:12px;right:12px;background:none;border:none;color:#5a6478;cursor:pointer;}
      ...
      <>
        ...
        <div className="rm-wrap"><div className="rm-inner">
          <div className="empty-state sr">
            ...
            <p style={{ fontSize: "18px", fontWeight: 600, color: "#edeff2", marginBottom: "6px" }}>Your Dream Map Awaits</p>
            <p style={{ fontSize: "13px", color: "#5a6478", marginBottom: "24px" }}>Generate an AI-powered roadmap with 15-20 detailed steps.</p>
    ...
    <>
      ...
      <div className="rm-wrap"><div className="rm-inner">
        <div className="rm-header sr">
          <div className="rm-icon"><Flag size={22} style={{ color: "#0a0a0a" }} /></div>
          ...
          <div className="rm-progress">
            ...
            {allDone && <button onClick={() => setShowCelebration(true)} style={{ background: "none", border: "none", color: "#f59e0b", cursor: "pointer", fontSize: "18px" }}><PartyPopper size={18} /></button>}
          </div>
        </div>
