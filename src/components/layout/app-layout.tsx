...
const STYLES = `
  ...
  .layout-root { display: flex; height: 100vh; overflow: hidden; background: #070c14; }
  ...
  /* Sidebar */
  .sidebar {
    height: 100vh; position: absolute; top: 0; left: 0; bottom: 0; z-index: 50;
  ...
  .logo-text { font-weight: 700; color: #edeff2; font-size: 17px; letter-spacing: 0.03em; white-space: nowrap; }
  ...
  .collapse-btn:hover { color: #f59e0b; background: rgba(245,158,11,0.06); }
  .collapse-icon { transition: transform 0.35s ease; }
  .collapse-icon.flipped { transform: rotate(180deg); }

  /* Navigation */
  .sidebar-nav { flex: 1; padding: 14px 10px; overflow-y: auto; display: flex; flex-direction: column; gap: 3px; }
  .nav-item {
    display: flex; align-items: center; gap: 12px; padding: 10px 14px;
    border-radius: 12px; text-decoration: none; font-size: 13px; font-weight: 500;
    color: #9aa4b8; transition: all 0.3s ease; position: relative; white-space: nowrap;
  }
  .nav-item:hover { color: #edeff2; background: rgba(255,255,255,0.02); }
  .nav-item.active {
  ...
  .nav-item.active::before {
    ...
    width: 2px; background: #f59e0b; border-radius: 0 2px 2px 0;
  }
  ...
  /* Bottom actions */
  .sidebar-bottom { padding: 14px 10px; border-top: 1px solid var(--border); display: flex; flex-direction: column; gap: 6px; }
  .create-btn {
  ...
  .create-btn:hover { transform: scale(1.03); box-shadow: 0 16px 36px -12px rgba(245,158,11,0.45); }
  .sidebar.collapsed .create-btn { justify-content: center; padding: 11px; }

  .logout-btn {
    display: flex; align-items: center; gap: 8px; padding: 10px 14px;
    border-radius: 12px; border: none; background: none; cursor: pointer;
    font-size: 13px; font-weight: 400; color: #5a6478;
    transition: all 0.3s ease; width: 100%; font-family: 'Inter', sans-serif;
  }
  .logout-btn:hover { color: #ef4444; background: rgba(239,68,68,0.04); }
  ...
  .menu-btn { background: none; border: none; color: #9aa4b8; cursor: pointer; padding: 8px; border-radius: 8px; transition: all 0.3s ease; }
  .menu-btn:hover { color: #f59e0b; background: rgba(245,158,11,0.06); }
...
>
        ...
        <div className="mobile-header">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginLeft: "10px" }}>
            ...
            <span style={{ fontWeight: 700, color: "#edeff2", fontSize: "15px" }}>ASCEND</span>
          </div>
        </div>
